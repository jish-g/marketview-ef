    ...
    <main className="blog-index-shell">
      ...
      <div className="blog-index-main">
        <div className="blog-index-head">
          ...
          <p>MarketCue is an AI-Agentic Option Intelligence Platform for Indian Stock Market — reading Nifty and Sensex data continuously through the trading day and turning it into a decision, not another chart to interpret. Daily gap, PCR, Max Pain, and option-readiness reads for both indices, published before the open and after the close.</p>
          <p>Every read on this page comes from the same continuous read the platform runs all session: Gap %, Open Interest structure, PCR, and Max Pain roll up into a Market Bias score, while India VIX, IV-vs-VIX, and days-to-expiry roll up into an Option Readiness score. Those two combine into a strategy recommendation — never a discretionary call. The full weighting and every band is public on the <Link href="/rules">rules page</Link>.</p>
