...
export const metadata: Metadata = {
  ...
  description: 'Who builds and maintains MarketCue, the AI-Agentic Option Intelligence Platform for Indian Stock Market, and how to reach us.',
        ...
        <div className="rules-doc-layout about-doc-layout">
          <article className="rules-doc-content">
            <div className="doc-hero">
              ...
              <p>
                MarketCue is built and maintained by Jishnu. It's an AI-Agentic Option
                Intelligence Platform for Indian Stock Market, reading Nifty and Sensex options
                data — Gap, Open Interest, PCR, Max Pain, IV and India VIX — continuously through
                the trading day and turning it into a decision, not another chart to interpret:
                a pre-market call before the open and a post-market recap after the close, every
                trading session. The full scoring methodology is public on the{' '}
                <Link href="/rules">rules page</Link>, and the daily reads are archived at{' '}
