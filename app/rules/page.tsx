...
export const metadata: Metadata = {
  ...
  description:
    'The exact weighted rules behind every MarketCue read: gap, OI, PCR, max pain, IV and India VIX inputs, and how they resolve to bias and option readiness.',
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Rules engine', item: 'https://marketcue.in/rules' },
  ],
}
