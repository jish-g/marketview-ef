...
export default function Dashboard() {
  ...
  const visiblePhases = session ? phases : phases.filter((p) => p.id !== 'trade')
  useEffect(() => { if (!sessionLoading && !session && phase === 'trade') setPhase('premarket') }, [sessionLoading, session, phase])
