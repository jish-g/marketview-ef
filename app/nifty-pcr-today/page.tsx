...
export const metadata: Metadata = {
  ...
  description: "Today's live Nifty Put-Call Ratio (PCR) and what it means for Market Bias, from MarketCue's AI-Agentic Option Intelligence Platform.",
...
export default async function NiftyPcrTodayPage() {
  ...
  const paragraphs = [
    `Nifty's Put-Call Ratio reads ${fmtNum(pcr)} as of ${asOfLabel} — MarketCue's AI-Agentic platform scores this as "${pcrRead(pcr)}". PCR is calculated as total put open interest divided by total call open interest across Nifty's option chain; it's a positioning indicator, not a price forecast, showing whether the market is more heavily hedged with puts or calls at any given moment.`,
